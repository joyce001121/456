...
$query_Recordset1 = "SELECT c1.*, c2.name as vendorname FROM product c1, vendor c2 where c1.vendor=c2.v_seq";
...
<table width="843" border="1" cellspacing="0" cellpadding="0">
  <tr>
    <th width="145" scope="col">Product Name</th>
    <th width="145" scope="col">Description</th>
    <th width="120" scope="col">Picture</th>
    <th width="357" scope="col">Vendor Name</th>
    <th width="64" scope="col">Action</th>
  </tr>
  <?php do { ?>
  <tr>
    <td align="center"><?php echo $row_Recordset1['name']; ?></td>
    <td align="center"><?php echo $row_Recordset1['detail']; ?></td>
    <td align="center">
      <img width="100px" height="100px" src="<?php echo $row_Recordset1['picture']; ?>" /> </td>
    <td align="center"><?php echo $row_Recordset1['vendorname']; ?> <?php echo $row_Recordset1['vendor']; ?></td>
    <td align="center"><a href="product-d.php?seq=<?php echo $row_Recordset1['p_seq']; ?>">刪除</a></td>
  </tr>
...
<p> <a href="product_add.php" target="new">新增</a></p>
